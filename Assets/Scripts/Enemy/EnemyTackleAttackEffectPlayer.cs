...
namespace GameName.Enemy
{
    ...
    [RequireComponent(typeof(EnemyTackleAttack))]
    public sealed class EnemyTackleAttackEffectPlayer : MonoBehaviour
    {
        [Header("Frames")]
        ...
        [Header("Placement")]
        [SerializeField] private Vector3 worldOffset = new Vector3(0.85f, -0.31f, 0f);
        ...
        private void OnEnable()
        {
            ...
            {
                tackleAttack.ChargeEnding -= HandleChargeEnding;
                tackleAttack.ChargeEnding += HandleChargeEnding;
            }
        }
        ...
        private void HandleChargeEnding()
        {
            ...
            effectObject = new GameObject("EnemyTackleAttackEffect");
