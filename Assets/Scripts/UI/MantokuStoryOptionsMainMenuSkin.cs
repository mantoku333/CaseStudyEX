...
public sealed class MantokuStoryOptionsMainMenuSkin : MonoBehaviour
{
...
public sealed class MantokuStoryOptionsMenuButtonState :
    MonoBehaviour,
    ISelectHandler,
    IDeselectHandler,
    ...
    IPointerExitHandler
{
    private static readonly System.Collections.Generic.List<MantokuStoryOptionsMenuButtonState> Instances = new();
    private static MantokuStoryOptionsMenuButtonState hoveredInstance;
