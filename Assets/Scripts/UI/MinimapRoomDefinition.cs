...
{
    private static readonly Color DefaultBossRoomColor = new Color(1f, 0.12f, 0.12f, 1f);
    ...
    [SerializeField] private Color bossRoomColor = new Color(1f, 0.12f, 0.12f, 1f);
    ...
    public MinimapRoomDefinition()
    {
        ...
        bossRoomColor = DefaultBossRoomColor;
    }
        ...
        Color bossRoomColor)
    {
        ...
        this.areaSize = new Vector2(Mathf.Max(0.1f, areaSize.x), Mathf.Max(0.1f, areaSize.y));
        this.isBossRoom = isBossRoom;
        this.bossRoomColor = bossRoomColor;
    }
